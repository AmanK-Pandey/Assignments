...
//Rules to declare a variable while storing the data - (Rules -> rules are those which are mandotory to follow)
// There are basically 6 rules
...
//let 1empName = "Jagadeesh";  (Can add number in the middle and at the end but not in the beginning)

//4. Variable name must not contain a special character. (Except these two -    $ , _)
//let my@Name = "Bharath";
...
// const empName = "Sarath";  (We should not use duplicate variable names)

//Standards to follow - (Standard ->Standard differ company to company and its not mandotory)
// There are basically 2 standards

//1. Variable name should be meaningful and self-explanatory.
// let n = 2244; (Not clear about the variable what it wants to say)
//let carNumber = 2244; (Clear about the variable)
